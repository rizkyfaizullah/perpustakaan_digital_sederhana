...
require '../includes/db.php'; // Menghubungkan ke database
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("
        INSERT INTO books (title, category_id, description, quantity, book_file, cover_image)
        VALUES (:title, :category_id, :description, :quantity, :book_file, :cover_image)
    ");
    $stmt->execute([
        ':title' => $title,
