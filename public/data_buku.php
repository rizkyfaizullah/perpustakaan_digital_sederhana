...
<div class="flex justify-between items-center mb-4">
    ...
    <a href="create_book.php" class="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600">Tambah Buku</a>
</div>
        ...
        <tbody>
            ...
            <?php foreach ($books as $book): ?>
                <tr>
                    ...
                    <td class="p-4 border-b text-center">
                        <a href="edit_book.php?id=<?php echo $book['id']; ?>" class="text-blue-500 hover:underline">Edit</a>
                        <a href="delete_book.php?id=<?php echo $book['id']; ?>" class="text-red-500 hover:underline ml-2" onclick="return confirm('Apakah Anda yakin ingin menghapus buku ini?');">Hapus</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
